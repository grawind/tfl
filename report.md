...
4.1) Пусть A = [[0, 0], [0, 0]], B = [[0, 0], [1, 0]], C = [[0, 1], [0, 0]]. Если подставить в исходную систему эти матрицы вместо соответсвующих букв, по произведение матриц в левой и правой части будет равно.

4.2) Пусть a = 0, b = 2, c = 0 в кольце Z₄ с операцией умножения. Тогда во всех правилах правые и левые части будут равны 0.
